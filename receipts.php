    ...
    <form method="POST">
      <div class="grid md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          ...
          <input type="email" name="clientEmail" id="clientEmail" class="mt-1 w-full border px-4 py-2 rounded focus:ring-2 focus:ring-blue-500"/>
        </div>
      ...
      <div class="mb-6">
        ...
        <input required type="number" step="0.01" name="amount" id="amount" class="mt-1 w-64 border px-4 py-2 rounded focus:ring-2 focus:ring-blue-500"/>
      </div>
