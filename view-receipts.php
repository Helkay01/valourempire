              ...
              <tr>
                   ...
                   <td class="px-4 py-3 border text-center">
                        <a href="print-receipt.php?
                            receipt_id=<?= urlencode($receipt['receipt_id'] ?? '') ?>
                            &description=<?= urlencode($receipt['description'] ?? '') ?>
                            &client_name=<?= urlencode($receipt['client_name'] ?? '') ?>
                            &client_email=<?= urlencode($receipt['client_email'] ?? '') ?>
                            &amount=<?= urlencode($receipt['amount'] ?? '') ?>
                            &date=<?= urlencode($receipt['payment_date'] ?? '') ?>
                            &payment_method=<?= urlencode($receipt['payment_method'] ?? '') ?>"
